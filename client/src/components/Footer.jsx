      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-6">
          ...
          <div className="col-span-2 sm:col-span-1">
            <Link to="/" className="text-xl font-bold text-blue-700 block mb-3">
              Medical Alert AI
            </Link>
            <p className="text-sm break-words">Gorakhpur</p>
            <p className="text-sm break-words">Uttar Pradesh</p>
            <p className="text-sm mt-2"><strong>Phone:</strong> 9219739903</p>
            <p className="text-sm"><strong>Email:</strong> medialert-services@gmail.com</p>
            <div className="flex space-x-3 mt-3 text-lg text-blue-700">
          ...
          {/* Working Hours */}
          <div>
            <h4 className="text-base font-semibold mb-2">Working Hours</h4>
            <ul className="space-y-1 text-sm break-words">
              <li>Mon - Fri: 9:00 AM - 6:00 PM</li>
              <li>Saturday: 10:00 AM - 4:00 PM</li>
              <li>Sunday: Closed</li>
              <li>Emergency: 24/7</li>
              <li>Email: medialert-services@gmail.com</li>
            </ul>
          </div>

          {/* Free Access */}
          <div>
            <h4 className="text-base font-semibold mb-2">It's Free</h4>
            <ul className="space-y-1 text-sm break-words">
