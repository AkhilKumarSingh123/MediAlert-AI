...
//         <p className="text-xl text-gray-600">Gorakhpur, UTTAR PRADESH</p>
//       </div>
...
//               <p className="text-lg text-gray-600">Gorakhpur, UTTAR PRADESH</p>
//             </div>
...
//                 <p className="text-lg text-gray-600">9219739903</p>
//               </div>
//               <div className="info-item flex flex-col justify-center items-center text-center bg-white-100 p-6 rounded-lg shadow-md w-1/2">
//                 <FaEnvelope className="text-3xl text-white-600 mb-3" />
//                 <h3 className="text-xl font-semibold text-black-700">Email Us</h3>
//                 <p className="text-sm md:text-lg text-gray-600">Medicalalertai@gmail.com</p>
//               </div>
//             </div>
//           </div>
